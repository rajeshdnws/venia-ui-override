...
const packagesToOverride = process.env.RAJESH_OVERRIDEPACKAGES
    ? process.env.RAJESH_OVERRIDEPACKAGES.split(',')
...
packagesToOverride.forEach(function(package) {
    ...
    const pluginName = 'rajesh/' + packagename + '-override-resolver';
